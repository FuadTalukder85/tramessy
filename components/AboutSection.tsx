  ...
  const values = [
    {
      title: "আমাদের লক্ষ্য",
      description:
        "বাংলাদেশের পরিবহন খাতকে সম্পূর্ণভাবে ডিজিটাল করা এবং আধুনিক প্রযুক্তির মাধ্যমে এই খাতে বিপ্লব আনা।",
      icon: Target,
      color: "bg-blue-500",
    },
    {
      ...
      description:
        "একটি স্মার্ট, দক্ষ এবং টেকসই পরিবহন ব্যবস্থা গড়ে তোলা যেখানে প্রযুক্তি মানুষের জীবনযাত্রার মান উন্নত করবে।",
      icon: Globe,
      color: "bg-green-500",
    },
    {
      ...
      description:
        "গ্রাহক সেবায় উৎকর্ষতা, উদ্ভাবনী চিন্তাভাবনা, স্বচ্ছতা এবং বিশ্বস্ততা আমাদের মূল মূল্যবোধ।",
      icon: Award,
      color: "bg-purple-500",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-primary-700 max-w-4xl mx-auto leading-relaxed">
            ট্র্যামেসি হলো বাংলাদেশের অগ্রগামী ট্রান্সপোর্ট ম্যানেজমেন্ট
            সফটওয়্যার কোম্পানি। আমরা আধুনিক প্রযুক্তির মাধ্যমে পরিবহন
            ব্যবসায়ীদের জন্য সহজ, কার্যকর এবং লাভজনক সমাধান প্রদান করি।
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6 text-primary-700 leading-relaxed">
              <p>
                ...
                ট্রান্সপোর্ট ম্যানেজমেন্ট সফটওয়্যার প্রদানকারী প্রতিষ্ঠান।
                আমাদের লক্ষ্য ছিল দেশের পরিবহন খাতে আনা এক নতুন দিগন্ত।
              </p>
              ...
              <p>
                ...
                আমাদের প্রতিটি ফিচার ডিজাইন করা হয়েছে ব্যবহারকারীর সুবিধা
                মাথায় রেখে। আমাদের ২৪/৭ কাস্টমার সাপোর্ট নিশ্চিত করে যে আপনি
            ...
            <div className="bg-primary-100 p-6 rounded-lg">
              <blockquote className="text-primary-800 italic text-lg">
                ...
                আধুনিক প্রযুক্তির সুবিধা পায় এবং তাদের ব্যবসায় উন্নতি করতে
                পারে।"
              </blockquote>
        ...
        >
          <h3 className="text-3xl font-bold mb-6">আমাদের অঙ্গীকার</h3>
          <p className="text-xl leading-relaxed max-w-4xl mx-auto">
            আমরা প্রতিশ্রুতিবদ্ধ যে আমাদের প্রতিটি ক্লায়েন্ট পাবেন সর্বোচ্চ
            মানের সেবা। আপনার ব্যবসার সফলতাই আমাদের সফলতা। আমরা আপনার পাশে থাকব
            আপনার ব্যবসার প্রতিটি পদক্ষেপে।
          </p>
        </motion.div>
      </div>
    </section>
