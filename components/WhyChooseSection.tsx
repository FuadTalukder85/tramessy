  ...
  const reasons = [
    {
      ...
      title: "অভিজ্ঞ টিম",
      description:
        "আমাদের আছে ৫+ বছরের অভিজ্ঞ প্রযুক্তিবিদ দল যারা পরিবহন ইন্ডাস্ট্রি সম্পর্কে গভীর জ্ঞান রাখেন।",
      color: "bg-yellow-500",
    },
    {
      icon: Heart,
      title: "গ্রাহক সেবা",
      description:
        "আমাদের প্রতিটি ক্লায়েন্ট আমাদের কাছে পরিবারের সদস্যের মতো। আমরা তাদের সফলতায় নিবেদিত।",
      color: "bg-red-500",
    },
    {
      icon: Zap,
      title: "দ্রুত সেবা",
      description:
        "আমাদের সফটওয়্যার ইনস্টল থেকে শুরু করে ট্রেনিং পর্যন্ত সবকিছু দ্রুততম সময়ে সম্পন্ন করি।",
      color: "bg-blue-500",
    },
    {
      icon: Trophy,
      ...
      description:
        "৫০০+ সন্তুষ্ট ক্লায়েন্ট এবং ৯৯% সফলতার হার আমাদের দক্ষতার প্রমাণ।",
      color: "bg-green-500",
    },
    {
      icon: ShieldCheck,
      title: "নিরাপত্তা",
      description:
        "আপনার ব্যবসার তথ্য সম্পূর্ণ নিরাপদ। আমরা ব্যাংক লেভেল সিকিউরিটি ব্যবহার করি।",
      color: "bg-purple-500",
    },
    {
      icon: Headphones,
      title: "২৪/৭ সাপোর্ট",
      description:
        "যেকোনো সমস্যায় আমাদের এক্সপার্ট টিম সর্বদা আপনার পাশে। দিন-রাত যেকোনো সময়।",
      color: "bg-indigo-500",
    },
    {
      icon: TrendingUp,
      ...
      description:
        "আমাদের সফটওয়্যার ব্যবহার করে গড়ে ৩০% বেশি লাভ করেন আমাদের ক্লায়েন্টরা।",
      color: "bg-orange-500",
    },
    {
      icon: Clock,
      title: "সময় সাশ্রয়",
      description:
        "ম্যানুয়াল কাজ কমিয়ে ৮০% পর্যন্ত সময় বাঁচান এবং সেই সময় ব্যবসার বিকাশে লাগান।",
      color: "bg-pink-500",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-primary-700 max-w-4xl mx-auto leading-relaxed">
            ...
            সাফল্যের জন্য কাজ করি। এখানে জানুন কেন হাজারো ব্যবসায়ী আমাদের
            বিশ্বাস করেন।
          </p>
        </motion.div>
          ...
          {reasons.map((reason, index) => (
            ...
            >
              <div className="text-center">
                <div
                  className={`${reason.color} p-4 rounded-full inline-flex mb-4 group-hover:scale-110 transition-transform`}
                >
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {/* Others */}
              <div className="text-center">
                <h4 className="text-2xl font-bold text-gray-600 mb-6">
                  অন্যান্য
                </h4>
