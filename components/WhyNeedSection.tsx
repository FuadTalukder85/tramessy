  ...
  const problems = [
    {
      ...
      description:
        "কাগজে হিসাব রাখার কারণে প্রায়ই ভুল হয় এবং টাকার হিসাব মিলে না।",
    ...
    },
    {
      ...
      title: "লাভ কম হওয়া",
      description:
        "সঠিক পরিকল্পনা ও নিয়ন্ত্রণের অভাবে প্রত্যাশিত লাভ পাওয়া যায় না।",
    ...
    },
    {
      ...
      title: "সময়ের অপচয়",
      description:
        "ম্যানুয়াল কাজের জন্য অনেক সময় নষ্ট হয় যা ব্যবসায় লাগানো যেত।",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-primary-700 max-w-4xl mx-auto leading-relaxed">
            আজকের যুগে প্রযুক্তি ছাড়া ব্যবসায় টিকে থাকা প্রায় অসম্ভব। দেখুন
            কীভাবে ট্রান্সপোর্ট ম্যানেজমেন্ট সফটওয়্যার আপনার ব্যবসার সমস্যার
            সমাধান করতে পারে।
          </p>
        </motion.div>
              ...
              {problems.map((problem, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div
                      className={`${problem.color} p-3 rounded-lg text-white`}
                    >
            ...
            {[
              {
                number: "৮৫%",
                label:
                  "ব্যবসায়ী যারা সফটওয়্যার ব্যবহার করেন তারা বেশি লাভবান",
              },
        ...
        >
          ...
          <p className="text-xl leading-relaxed max-w-3xl mx-auto mb-8">
            প্রতিদিন যে সময় ও টাকা নষ্ট হচ্ছে, তা বন্ধ করুন আজই। ট্র্যামেসির
            সাথে যুক্ত হয়ে আপনার ব্যবসাকে নিয়ে যান নতুন উচ্চতায়।
          </p>
