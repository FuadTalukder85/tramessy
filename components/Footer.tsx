      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-primary-300 -mt-1">Transport Management</p>
              </div>
            </div>
            
            <p className="text-primary-200 leading-relaxed mb-6">
              বাংলাদেশের অগ্রগামী ট্রান্সপোর্ট ম্যানেজমেন্ট সফটওয়্যার কোম্পানি। 
              আমরা আধুনিক প্রযুক্তির মাধ্যমে পরিবহন ব্যবসায়ীদের সফলতার পথ দেখাই।
            </p>
        ...
        >
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold mb-2">আপডেট পেতে সাবস্ক্রাইব করুন</h3>
